...
/**
 * The "Overview" tab of /markets (Phase 3 consolidation,
 * docs/ALPHASTREAM_UX_REDESIGN.md §Phase 3 / Appendix). The old standalone
 * /overview page's "Today's Focus" and "What changed" panels are gone from
 * here — /today (built on the futures-plan + GEX digest, not just stock
 * recommendations) is the better version of that job now. What's kept is
 * genuine market-environment context: the AI report, VIX, global markets,
 * ATH highlights, and news.
 */
...
/* ── AI Report — falls back to older sessions on 404 ── */
